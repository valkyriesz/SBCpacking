  ...
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="userList">List of Users</a></li>
          <li><a href="updateUser">Update User</a></li>
          <li><a href="regUser">Register User</a></li>
    ...
    <div id="site_content">
      <div class="sidebar">
        ...
        <h3>Search</h3>
        <form method="POST" action="userList" id="search_form">
          <p>
            <input class="search" type="text" name="username" placeholder="Enter keywords....."  required/>
      ...
      <div id="content">
        ...
        <c:if test="${empty allUsers}" >
        	<tr> 
				<td colspan="3" class="aligncenter">No Result(s) Found</td>				
			</tr>			
		</c:if>
